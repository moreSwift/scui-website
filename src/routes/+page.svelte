...
<section id="main">
    ...
    <div style="display: flex; flex-direction: row; flex-wrap: wrap; margin: auto; width: 100%; align-items: center; justify-content: center; row-gap: 0.5rem;">
        <a href="https://docs.swiftcrossui.dev/tutorials/swiftcrossui/quick-start" class={"w-32 mr-2 " + buttonVariants({ size: "sm" })}>Get started</a>
        <a href="https://opencollective.com/moreswift" class={"w-32 mr-2 " + buttonVariants({ size: "sm", variant: "outlineProminent" })}>
